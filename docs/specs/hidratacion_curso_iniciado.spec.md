...
- **REQ-005:** La vista previa DOCX debe extraer texto, hash, conteo de reactivos y clasificar documentos como encuadre, parcial externo o temario/documento de apoyo.
...
- **AC-005 (REQ-005):** Un DOCX de parcial reporta reactivos detectados y tipo `parcial_externo`; un encuadre reporta tipo `encuadre`.
...
| REQ-005 | Clasificacion DOCX | `apps/backend/tests/integracion/hidratacionCursos.test.ts` | Completado |
