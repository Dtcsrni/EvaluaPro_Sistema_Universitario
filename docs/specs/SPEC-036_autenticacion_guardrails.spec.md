...
| REQ-002 | Login Google sin allowlist de dominio | `apps/backend/tests/integracion/autenticacionSesion.test.ts` y `apps/frontend/tests/seccionAutenticacion.test.tsx` | Completado |
