...
- **AC-014 (REQ-014):** Tras construir el frontend docente y antes de empaquetar el bundle, `installer-docente-static-smoke.mjs` valida que el servidor estático real responda HTTP 200 en `/` y entregue HTML SPA.
