...
- sessionId: sesion-2026-05-27T13-37-44.687Z
- parentSessionId: -
- status: draft
- generatedAt: 2026-05-27T13:37:44.687Z
...
## Acciones
- [omitido] validation: Ejecucion de lint (2026-05-27T13:37:44.687Z)
- [omitido] validation: Ejecucion de typecheck (2026-05-27T13:37:44.687Z)
- [omitido] validation: Ejecucion de test_frontend_ci (2026-05-27T13:37:44.687Z)
- [omitido] validation: Ejecucion de test_coverage_ci (2026-05-27T13:37:44.687Z)
- [omitido] validation: Ejecucion de test_tdd_enforcement_ci (2026-05-27T13:37:44.687Z)
- [omitido] validation: Ejecucion de test_backend_ci (2026-05-27T13:37:44.687Z)
- [omitido] validation: Ejecucion de test_portal_ci (2026-05-27T13:37:44.687Z)
- [omitido] validation: Ejecucion de perf_check (2026-05-27T13:37:44.687Z)
- [ok] validation: Ejecucion de pipeline_contract_check (2026-05-27T13:37:44.687Z)
- [ok] validation: Ejecucion de docs_check (2026-05-27T13:37:44.687Z)
...
- perf_check: `npm run perf:check` -> omitido (exitCode=-, duracionMs=0)
  resultado: omitido por perfil quick
- pipeline_contract_check: `npm run pipeline:contract:check` -> ok (exitCode=0, duracionMs=644)
  resultado: > evaluapro@1.0.0 pipeline:contract:check | > node scripts/pipeline-contract-check.mjs | ✔ ext_perf_arquitectura prepara sharp antes de perf:check (2.323ms) | ✔ ext_funcionales usa gate OMR TV generico con version configurable (0.3569ms) | ... | ℹ duration_ms 96.339 | pipeline contract OK
- docs_check: `npm run docs:check` -> ok (exitCode=0, duracionMs=687)
...
- docs/handoff/sesiones/2026-05-27/sesion-2026-05-27T13-37-44.687Z.md
