...
- sessionId: sesion-2026-05-27T09-37-09.875Z
- parentSessionId: -
- status: draft
- generatedAt: 2026-05-27T09:37:09.875Z
...
## Acciones
- [omitido] validation: Ejecucion de lint (2026-05-27T09:37:09.875Z)
- [omitido] validation: Ejecucion de typecheck (2026-05-27T09:37:09.875Z)
- [omitido] validation: Ejecucion de test_frontend_ci (2026-05-27T09:37:09.875Z)
- [omitido] validation: Ejecucion de test_coverage_ci (2026-05-27T09:37:09.875Z)
- [omitido] validation: Ejecucion de test_tdd_enforcement_ci (2026-05-27T09:37:09.875Z)
- [omitido] validation: Ejecucion de test_backend_ci (2026-05-27T09:37:09.875Z)
- [omitido] validation: Ejecucion de test_portal_ci (2026-05-27T09:37:09.875Z)
- [omitido] validation: Ejecucion de perf_check (2026-05-27T09:37:09.875Z)
- [ok] validation: Ejecucion de pipeline_contract_check (2026-05-27T09:37:09.875Z)
- [falla] validation: Ejecucion de docs_check (2026-05-27T09:37:09.875Z)
...
- reports/qa/latest/frontend-docente-vite.err.log
- reports/qa/latest/frontend-docente-vite.log
...
- perf_check: `npm run perf:check` -> omitido (exitCode=-, duracionMs=0)
  resultado: omitido por perfil quick
- pipeline_contract_check: `npm run pipeline:contract:check` -> ok (exitCode=0, duracionMs=947)
  resultado: > evaluapro@1.0.0 pipeline:contract:check | > node scripts/pipeline-contract-check.mjs | ✔ ext_perf_arquitectura prepara sharp antes de perf:check (4.5086ms) | ✔ ext_funcionales usa gate OMR TV generico con version configurable (0.5183ms) | ... | ℹ duration_ms 158.1545 | pipeline contract OK
- docs_check: `npm run docs:check` -> falla (exitCode=1, duracionMs=1010)
...
- docs/handoff/sesiones/2026-05-27/sesion-2026-05-27T09-37-09.875Z.md
