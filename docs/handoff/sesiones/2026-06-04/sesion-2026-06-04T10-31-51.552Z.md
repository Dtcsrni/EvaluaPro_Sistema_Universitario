...
- sessionId: sesion-2026-06-04T10-31-51.552Z
- parentSessionId: -
- status: draft
- generatedAt: 2026-06-04T10:31:51.552Z
...
## Acciones
- [omitido] validation: Ejecucion de lint (2026-06-04T10:31:51.552Z)
- [omitido] validation: Ejecucion de typecheck (2026-06-04T10:31:51.552Z)
- [omitido] validation: Ejecucion de test_frontend_ci (2026-06-04T10:31:51.552Z)
- [omitido] validation: Ejecucion de test_coverage_ci (2026-06-04T10:31:51.552Z)
- [omitido] validation: Ejecucion de test_tdd_enforcement_ci (2026-06-04T10:31:51.552Z)
- [omitido] validation: Ejecucion de test_backend_ci (2026-06-04T10:31:51.552Z)
- [omitido] validation: Ejecucion de test_portal_ci (2026-06-04T10:31:51.552Z)
- [omitido] validation: Ejecucion de perf_check (2026-06-04T10:31:51.552Z)
- [ok] validation: Ejecucion de pipeline_contract_check (2026-06-04T10:31:51.552Z)
- [falla] validation: Ejecucion de docs_check (2026-06-04T10:31:51.552Z)
...
- perf_check: `npm run perf:check` -> omitido (exitCode=-, duracionMs=0)
  resultado: omitido por perfil quick
- pipeline_contract_check: `npm run pipeline:contract:check` -> ok (exitCode=0, duracionMs=570)
  resultado: > evaluapro@1.0.0 pipeline:contract:check | > node scripts/pipeline-contract-check.mjs | ✔ ext_perf_arquitectura prepara sharp antes de perf:check (2.5179ms) | ✔ ext_funcionales usa gate OMR TV generico con version configurable (0.42ms) | ... | ℹ duration_ms 102.9057 | pipeline contract OK
- docs_check: `npm run docs:check` -> falla (exitCode=1, duracionMs=959)
...
- docs/handoff/sesiones/2026-06-04/sesion-2026-06-04T10-31-51.552Z.md
