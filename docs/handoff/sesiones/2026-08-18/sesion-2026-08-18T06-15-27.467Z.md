...
- sessionId: sesion-2026-08-18T06-15-27.467Z
- parentSessionId: -
- status: draft
- generatedAt: 2026-08-18T06:15:27.467Z
...
## Acciones
- [omitido] validation: Ejecucion de lint (2026-08-18T06:15:27.467Z)
- [omitido] validation: Ejecucion de typecheck (2026-08-18T06:15:27.467Z)
- [omitido] validation: Ejecucion de test_frontend_ci (2026-08-18T06:15:27.467Z)
- [omitido] validation: Ejecucion de test_coverage_ci (2026-08-18T06:15:27.467Z)
- [omitido] validation: Ejecucion de test_tdd_enforcement_ci (2026-08-18T06:15:27.467Z)
- [omitido] validation: Ejecucion de test_backend_ci (2026-08-18T06:15:27.467Z)
- [omitido] validation: Ejecucion de test_portal_ci (2026-08-18T06:15:27.467Z)
- [omitido] validation: Ejecucion de perf_check (2026-08-18T06:15:27.467Z)
- [ok] validation: Ejecucion de pipeline_contract_check (2026-08-18T06:15:27.467Z)
- [falla] validation: Ejecucion de docs_check (2026-08-18T06:15:27.467Z)
...
- perf_check: `npm run perf:check` -> omitido (exitCode=-, duracionMs=0)
  resultado: omitido por perfil quick
- pipeline_contract_check: `npm run pipeline:contract:check` -> ok (exitCode=0, duracionMs=498)
  resultado: > evaluapro@1.1.1 pipeline:contract:check | > node scripts/pipeline-contract-check.mjs | ✔ ext_perf_arquitectura prepara sharp antes de perf:check (2.4249ms) | ✔ ext_funcionales usa gate OMR TV generico con version configurable (0.6277ms) | ... | ℹ duration_ms 91.2141 | pipeline contract OK
- docs_check: `npm run docs:check` -> falla (exitCode=1, duracionMs=6237)
...
- docs/handoff/sesiones/2026-08-18/sesion-2026-08-18T06-15-27.467Z.md
