...
- sessionId: sesion-2026-08-26T02-19-58.580Z
- parentSessionId: -
- status: draft
- generatedAt: 2026-08-26T02:19:58.580Z
...
## Acciones
- [omitido] validation: Ejecucion de lint (2026-08-26T02:19:58.580Z)
- [omitido] validation: Ejecucion de typecheck (2026-08-26T02:19:58.580Z)
- [omitido] validation: Ejecucion de test_frontend_ci (2026-08-26T02:19:58.580Z)
- [omitido] validation: Ejecucion de test_coverage_ci (2026-08-26T02:19:58.580Z)
- [omitido] validation: Ejecucion de test_tdd_enforcement_ci (2026-08-26T02:19:58.580Z)
- [omitido] validation: Ejecucion de test_backend_ci (2026-08-26T02:19:58.580Z)
- [omitido] validation: Ejecucion de test_portal_ci (2026-08-26T02:19:58.580Z)
- [omitido] validation: Ejecucion de perf_check (2026-08-26T02:19:58.580Z)
- [ok] validation: Ejecucion de pipeline_contract_check (2026-08-26T02:19:58.580Z)
- [falla] validation: Ejecucion de docs_check (2026-08-26T02:19:58.580Z)
...
- perf_check: `npm run perf:check` -> omitido (exitCode=-, duracionMs=0)
  resultado: omitido por perfil quick
- pipeline_contract_check: `npm run pipeline:contract:check` -> ok (exitCode=0, duracionMs=516)
  resultado: > evaluapro@1.1.1 pipeline:contract:check | > node scripts/pipeline-contract-check.mjs | ✔ ext_perf_arquitectura prepara sharp antes de perf:check (1.8805ms) | ✔ ext_funcionales usa gate OMR TV generico con version configurable (0.6346ms) | ... | ℹ duration_ms 94.5724 | pipeline contract OK
- docs_check: `npm run docs:check` -> falla (exitCode=1, duracionMs=1080)
...
- docs/handoff/sesiones/2026-08-26/sesion-2026-08-26T02-19-58.580Z.md
