...
- sessionId: sesion-2026-06-05T09-56-37.337Z
- parentSessionId: -
- status: final
- generatedAt: 2026-06-05T09:56:37.337Z
...
## Solicitud
- Incluir términos y condiciones como pantalla independiente antes de la pantalla de instalación, y bloquear navegación si no se aceptan.

## Objetivo
- Integrar la pantalla de Términos y Condiciones en el bootstrapper WPF del instalador, permitiendo avanzar solo si se aceptan (en modo instalación), e inhabilitar retroceso inválido en modos de reparación/desinstalación. Implementar autoelevación UAC en el script helper post-install.
...
## Acciones
- [omitido] validation: Ejecucion de lint (2026-06-05T09:56:37.337Z)
- [omitido] validation: Ejecucion de typecheck (2026-06-05T09:56:37.337Z)
- [omitido] validation: Ejecucion de test_frontend_ci (2026-06-05T09:56:37.337Z)
- [omitido] validation: Ejecucion de test_coverage_ci (2026-06-05T09:56:37.337Z)
- [omitido] validation: Ejecucion de test_tdd_enforcement_ci (2026-06-05T09:56:37.337Z)
- [omitido] validation: Ejecucion de test_backend_ci (2026-06-05T09:56:37.337Z)
- [omitido] validation: Ejecucion de test_portal_ci (2026-06-05T09:56:37.337Z)
- [omitido] validation: Ejecucion de perf_check (2026-06-05T09:56:37.337Z)
- [ok] validation: Ejecucion de pipeline_contract_check (2026-06-05T09:56:37.337Z)
- [ok] validation: Ejecucion de docs_check (2026-06-05T09:56:37.337Z)
...
- perf_check: `npm run perf:check` -> omitido (exitCode=-, duracionMs=0)
  resultado: omitido por perfil quick
- pipeline_contract_check: `npm run pipeline:contract:check` -> ok (exitCode=0, duracionMs=500)
  resultado: > evaluapro@1.0.0 pipeline:contract:check | > node scripts/pipeline-contract-check.mjs | ✔ ext_perf_arquitectura prepara sharp antes de perf:check (1.6653ms) | ✔ ext_funcionales usa gate OMR TV generico con version configurable (0.2712ms) | ... | ℹ duration_ms 86.6977 | pipeline contract OK
- docs_check: `npm run docs:check` -> ok (exitCode=0, duracionMs=564)
  resultado: > evaluapro@1.0.0 docs:check | > node scripts/docs.mjs --check | [docs] ok

## Decisiones
- Definir WizardStep.Terms = 0 en el bootstrapper WPF y ampliar el stepper a 5 pasos.
- Bajo modo de instalación, bloquear la navegación (botones Siguiente e Iniciar) hasta que AcceptTermsCheckBox esté marcado.
- Deshabilitar dinámicamente el botón de retroceso (Atrás) en el paso Preparar si se cambia el modo a reparación o desinstalación.
- Añadir bloque de autoelevación UAC (Start-Process RunAs) en InstallerBurnHelper.ps1 si falta acceso de escritura y no está en modo reparación simplificado.

## Supuestos
- Sin supuestos declarados.

## Riesgos abiertos
- Posible rechazo de elevación UAC por parte del usuario, lo que interrumpirá la post-instalación local.
...
- Realizar commit y push de las modificaciones, y verificar la correcta generación de instaladores mediante el pipeline CI Checks.

## Artefactos generados
- docs/handoff/sesiones/2026-06-05/sesion-2026-06-05T09-56-37.337Z.json
- docs/handoff/sesiones/2026-06-05/sesion-2026-06-05T09-56-37.337Z.md
