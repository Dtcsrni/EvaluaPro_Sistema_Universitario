...
- sessionId: sesion-2026-08-20T07-26-22.589Z
- parentSessionId: -
- status: draft
- generatedAt: 2026-08-20T07:26:22.589Z
...
## Acciones
- [omitido] validation: Ejecucion de lint (2026-08-20T07:26:22.589Z)
- [omitido] validation: Ejecucion de typecheck (2026-08-20T07:26:22.589Z)
- [omitido] validation: Ejecucion de test_frontend_ci (2026-08-20T07:26:22.589Z)
- [omitido] validation: Ejecucion de test_coverage_ci (2026-08-20T07:26:22.589Z)
- [omitido] validation: Ejecucion de test_tdd_enforcement_ci (2026-08-20T07:26:22.589Z)
- [omitido] validation: Ejecucion de test_backend_ci (2026-08-20T07:26:22.589Z)
- [omitido] validation: Ejecucion de test_portal_ci (2026-08-20T07:26:22.589Z)
- [omitido] validation: Ejecucion de perf_check (2026-08-20T07:26:22.589Z)
- [ok] validation: Ejecucion de pipeline_contract_check (2026-08-20T07:26:22.589Z)
- [falla] validation: Ejecucion de docs_check (2026-08-20T07:26:22.589Z)
...
- perf_check: `npm run perf:check` -> omitido (exitCode=-, duracionMs=0)
  resultado: omitido por perfil quick
- pipeline_contract_check: `npm run pipeline:contract:check` -> ok (exitCode=0, duracionMs=490)
  resultado: > evaluapro@1.1.1 pipeline:contract:check | > node scripts/pipeline-contract-check.mjs | ✔ ext_perf_arquitectura prepara sharp antes de perf:check (1.7449ms) | ✔ ext_funcionales usa gate OMR TV generico con version configurable (0.6593ms) | ... | ℹ duration_ms 87.6256 | pipeline contract OK
- docs_check: `npm run docs:check` -> falla (exitCode=1, duracionMs=6254)
...
- docs/handoff/sesiones/2026-08-20/sesion-2026-08-20T07-26-22.589Z.md
